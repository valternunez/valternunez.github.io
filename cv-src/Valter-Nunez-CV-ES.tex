...
\begin{tight}
  ...
  \item \proyecto{Momentum del Mundial 2026}{pipeline de datos de experimento natural (scraping local $\rightarrow$ GitHub Actions $\rightarrow$ Pages) que se regeneró a diario.}
\end{tight}
